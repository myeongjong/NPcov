...
save(cvout, ptm_cv, bestout, ptm_best, file = "rdata/simout_uniform_wave_simple.RData")
...
save(cvout, ptm_cv, bestout, ptm_best, file = "rdata/simout_uniform_wave_complex.RData")
...
save(cvout, ptm_cv, bestout, ptm_best, file = "rdata/simout_uniform_sphe_simple.RData")
...
save(cvout, ptm_cv, bestout, ptm_best, file = "rdata/simout_uniform_sphe_complex.RData")
...
save(cvout, ptm_cv, bestout, ptm_best, file = "rdata/simout_uniform_expo_simple.RData")
...
save(cvout, ptm_cv, bestout, ptm_best, file = "rdata/simout_uniform_expo_complex.RData")
