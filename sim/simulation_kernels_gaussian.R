...
save(cvout, ptm_cv, bestout, ptm_best, file = "out/simout_gaussian_wave_simple.RData")
...
save(cvout, ptm_cv, bestout, ptm_best, file = "out/simout_gaussian_wave_complex.RData")
...
save(cvout, ptm_cv, bestout, ptm_best, file = "out/simout_gaussian_sphe_simple.RData")
...
save(cvout, ptm_cv, bestout, ptm_best, file = "out/simout_gaussian_sphe_complex.RData")
...
save(cvout, ptm_cv, bestout, ptm_best, file = "out/simout_gaussian_expo_simple.RData")
...
save(cvout, ptm_cv, bestout, ptm_best, file = "out/simout_gaussian_expo_complex.RData")
